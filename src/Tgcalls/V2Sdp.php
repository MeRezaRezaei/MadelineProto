...
final class V2Sdp
{
     ...
     * @return list<array<string, mixed>> One `MediaContent` per m-line.
     */
    public static function contentsFromOffer(string $offer): array
    {
    ...
    public static function buildRemoteDescription(
        ...
        $flush = static function () use (&$result, &$pending, &$index, $contents, $fingerprints, $ufrag, $pwd, $setup): void {
            if ($pending === []) {
                return;
            }
            ...
            if ($content === null) {
                // The peer did not describe this m-line: reject it so the indexes stay aligned.
                $result[] = 'a=inactive';
                return;
            }
